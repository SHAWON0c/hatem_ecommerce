...
// import { useOtpVerificationforgotpasswordMutation, useResendOtpMutation } from "@/redux/features/auth/authApi";
...
//       .catch((error) => {
//         api.error({
//           message: (error as any)?.data?.message || "Verification failed",
...
//       .catch((error) => {
//         api.error({
//           message: (error as any)?.data?.message || "Failed to resend OTP",
